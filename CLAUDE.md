...
./scripts/mavp-operator --quick-merge    # fast-track an XS change directly to merged (title + commit hash); use only for <=2 files, <=10 lines diff, no risk — see docs/core/ORCHESTRATION_RULES.md "XS fast lane (quick-merge)" for the enforced thresholds and attested conditions
